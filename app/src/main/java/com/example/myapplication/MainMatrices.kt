...
fun main (){
    do {
        ...
        when(op){
             ...
             8->matrizEjercicio8()
             9 ->matrizEjercicio9()
            10->matrizEjercicio10()
            11->matrizEjercicio11()
            12->matrizEjercicio12()
            13->matrizEjercicio13()
            14->matrizEjercicio14()
            15->matrizEjercicio15()
            16->matrizEjercicio16()
            17->matrizEjercicio17()
            18->matrizEjercicio18()
            19->matrizEjercicio19()
            20->matrizEjercicio20()
        }
    }while(op != -1)
...
fun matrizEjercicio6() {
    ...
    var matrizA = Array(filas) { Array(columnas) { 0 } }
    ...
    var matrizB = Array(filas) { Array(columnas) { 0 } }
...
fun matrizEjercicio8() {
    ...
    for (i in matrix.indices) {
        for (j in matrix[i].indices) {
            matrix[i][j] = if (matrix[i][j] < 0) 0 else 9
        }
    }
...
fun matrizEjercicio19(){
    ...
    while (top <= bottom && left <= right) {
        for (i in left..right) matriz[top][i] = value++
        top++
        for (i in top..bottom) matriz[i][right] = value++
        right--
        for (i in right downTo left) matriz[bottom][i] = value++
        bottom--
        for (i in bottom downTo top) matriz[i][left] = value++
        left++
    }
